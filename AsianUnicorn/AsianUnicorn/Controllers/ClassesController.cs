...
namespace AsianUnicorn.Controllers
{
    public class ClassesController : Controller
    {
        ...
        public async Task<ActionResult> Create([Bind(Include = "IDClass,NameClass,DescriptionClass")] Class @class)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<ActionResult> Edit([Bind(Include = "IDClass,NameClass,DescriptionClass")] Class @class)
        {
            if (ModelState.IsValid)
            {
