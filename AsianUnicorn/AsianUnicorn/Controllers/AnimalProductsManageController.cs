...
{
    public class AnimalProductsManageController : Controller
    {
        private Hackathon2021Entities db = new Hackathon2021Entities();

        // GET: AnimalProductsManage
        ...
        // GET: AnimalProductsManage/Details/5
        ...
        // GET: AnimalProductsManage/Create
        ...
        // POST: AnimalProductsManage/Create
        ...
        // GET: AnimalProductsManage/Edit/5
        ...
        // POST: AnimalProductsManage/Edit/5
        // To protect from overposting attacks, please enable the specific properties you want to bind to, for 
        // more details see https://go.microsoft.com/fwlink/?LinkId=317598.
        [HttpPost]
        [ValidateAntiForgeryToken]
        ...
        // GET: AnimalProductsManage/Delete/5
        ...
        // POST: AnimalProductsManage/Delete/5
